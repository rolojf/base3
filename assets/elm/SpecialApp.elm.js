...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { ba: 'hidden', a$: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { ba: 'mozHidden', a$: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { ba: 'msHidden', a$: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { ba: 'webkitHidden', a$: 'webkitvisibilitychange' }
		: { ba: 'hidden', a$: 'visibilitychange' };
}
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.bd, request.bE, true);
		} catch (e) {
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{aX: false, aZ: r.aZ, a5: r.a5, an: r.an, bd: r.bd, bB: r.bB, aQ: r.aQ, bE: r.bE}));
};
var $elm$http$Http$get = function (r) {
	return $elm$http$Http$request(
		{aZ: $elm$http$Http$emptyBody, a5: r.a5, an: _List_Nil, bd: 'GET', bB: $elm$core$Maybe$Nothing, aQ: $elm$core$Maybe$Nothing, bE: r.bE});
};
				...
				if (!res.$) {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								K: 'Error: ' + $author$project$SpecialApp$httpErrorToString(err)
							}),
						$elm$core$Platform$Cmd$none);
				}
		}
	});
var $author$project$SpecialApp$Inc = {$: 0};
var $author$project$SpecialApp$TestServer = {$: 2};
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Elm 0.19.1 Webpack Starter, with hot-reloading')
							]))
					])),
				A2(
				$elm$html$Html$p,
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Click on the button below to increment the state.')
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text('ping dev server')
									])),
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Then make a change to the source code and see how the state is retained after you recompile.')
					])),
				A2(
				$elm$html$Html$p,
				_List_Nil,
				_List_fromArray(
					[
						$elm$html$Html$text('And now don\'t forget to add a star to the Github repo '),
						A2(
						$elm$html$Html$a,
						_List_fromArray(
							[
								$elm$html$Html$Attributes$href('https://github.com/simonh1000/elm-webpack-starter')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('elm-webpack-starter')
							]))
					]))
			]));
};
var $author$project$SpecialApp$main = $elm$browser$Browser$document(
	{
		bc: $author$project$SpecialApp$init,
		by: function (_v0) {
			return $elm$core$Platform$Sub$none;
		},
		bD: $author$project$SpecialApp$update,
		bF: function (m) {
			return {
				aZ: _List_fromArray(
					[
